...
const PageBreakSVGButton = () => {
  ...
  return (
    <div
      className="position-relative clear-both m-0 block h-[50vh] w-full bg-[#d3d3d3]/35 p-0 dark:bg-gray-400/20"
      style={{ isolation: 'isolate', zIndex: 10 }}
    >
      <div
        className={`absolute left-[10%] top-32 transition-opacity duration-500 sm:left-[15%] sm:top-24 md:left-1/4 md:top-32 lg:left-[20%] lg:top-28 ${showCTA ? 'opacity-100' : 'opacity-0'}`}
      >
        <div className="relative">
          <Link href="#featured-projects">
            <Image
              ...
              unoptimized={false}
            />
            <p className="absolute -inset-0 ml-3 flex -translate-y-8 items-center justify-center text-center text-black dark:text-neutral-50 sm:ml-4 sm:-translate-y-10 md:ml-4 md:-translate-y-10 lg:ml-5 lg:-translate-y-12">
