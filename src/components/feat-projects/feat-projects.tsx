...
export default function FeaturedProjects() {
  return (
    <div
      ...
      className="scroll-mt-[25vh] bg-gradient-to-br from-[#cccccc] via-[#b6ceba] to-[#cccccc] py-8 sm:py-12 md:py-16 dark:from-gray-900 dark:via-[#ff2b2b6c] dark:to-gray-950"
    >
